...
// Default barriers if not specialized above
...
#ifndef FULL_MEM_BARRIER
#define FULL_MEM_BARRIER __sync_synchronize()
#endif

#ifndef LIGHT_MEM_BARRIER
#ifdef __ATOMIC_ACQ_REL
#define LIGHT_MEM_BARRIER __atomic_thread_fence(__ATOMIC_ACQ_REL);
#else
// Warning: the definition below assumes the CPU has TSO semantics.
// It is not valid for non-TSO platforms.
