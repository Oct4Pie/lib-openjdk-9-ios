...
#ifdef _LP64
inline intptr_t OrderAccess::load_ptr_acquire(volatile intptr_t*   p) { return (intptr_t)specialized_load_acquire((volatile jlong*)p); }
#else
inline intptr_t OrderAccess::load_ptr_acquire(volatile intptr_t*   p) { return (intptr_t)specialized_load_acquire((volatile jint*)p); }
#endif
inline void*    OrderAccess::load_ptr_acquire(volatile void*       p) { return (void*)load_ptr_acquire((volatile intptr_t*)p); }
inline void*    OrderAccess::load_ptr_acquire(const volatile void* p) { return (void*)load_ptr_acquire((volatile intptr_t*)p); }
...
#ifdef _LP64
inline void     OrderAccess::release_store_ptr(volatile intptr_t* p, intptr_t v) { specialized_release_store((volatile jlong*)p, (jlong)v); }
#else
inline void     OrderAccess::release_store_ptr(volatile intptr_t* p, intptr_t v) { specialized_release_store((volatile jint*)p, (jint)v); }
#endif
inline void     OrderAccess::release_store_ptr(volatile void*     p, void*    v) { release_store_ptr((volatile intptr_t*)p, (intptr_t)v); }
...
#ifdef _LP64
inline void     OrderAccess::release_store_ptr_fence(volatile intptr_t* p, intptr_t v) { specialized_release_store_fence((volatile jlong*)p, (jlong)v); }
#else
inline void     OrderAccess::release_store_ptr_fence(volatile intptr_t* p, intptr_t v) { specialized_release_store_fence((volatile jint*)p, (jint)v); }
#endif
inline void     OrderAccess::release_store_ptr_fence(volatile void*     p, void*    v) { release_store_ptr_fence((volatile intptr_t*)p, (intptr_t)v); }
