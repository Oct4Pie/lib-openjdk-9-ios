...
static jclass dalvikProxySelectorClass = NULL;
static jmethodID getProxyMethodId = NULL;
...
static jclass initDalvikProxySelectorClass(JNIEnv* env) {
    ...
    __android_log_print(3, "DalvikProxySelector", ">>> after FindClass DalvikProxySelectorClass = %x", (unsigned int) dalvikProxySelectorClass);
